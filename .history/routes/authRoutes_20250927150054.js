...
const { authMiddleware, userMiddleware, adminMiddleware } = require("../middleware/auth");
...
router.get("/user/edit",authMiddleware ,adminMiddleware, userMiddleware,function(req,res){
